    ...
    return(
      ...
      <div class="login-square">
        <div class="panel">
          ...
          <div class="row">
            <div class="col-md-5">
              <button class="btn btn-block google-btn"><i class="fa fa-google icon-pos"></i>Ingresar con <b>Google</b></button>
              <button class="btn btn-block facebook-btn"><i class="fa fa-facebook-f icon-pos"></i>Ingresar con <b>Facebook</b></button>
              <button class="btn btn-block twitter-btn"><i class="fa fa-twitter icon-pos"></i>Ingresar con <b>Twitter</b></button>
            </div>
